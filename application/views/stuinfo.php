...
<body>
  ...
  <tr>
    <td><br><?php echo $s['stuUsername']?></td>
    <td><br><?php echo $s['stuCode']?></td>
    <td><br><?php echo $s['stuName']?></td>
    <td><br><?php echo $s['stuLastname']?></td>
    <td><br><?php echo $s['stuAddress']?></td>
    <td><br><?php echo $s['stuTel']?></td>
    <td><br><?php echo $s['stuEmail']?></td>
    <td><a href="<?php echo base_url();?>index.php/students/stuedit/<?php echo $s['stuId']?>">แก้ไขข้อมูล</a></td>
  </tr>
  <?php }?>
</table>
</div>
