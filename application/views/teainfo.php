...
<body>
  ...
  <tr>
    <td><br><?php echo $t['teaUsername']?></td>
    <td><br><?php echo $t['teaCode']?></td>
    <td><br><?php echo $t['teaName']?></td>
    <td><br><?php echo $t['teaLastname']?></td>
    <td><br><?php echo $t['teaAddress']?></td>
    <td><br><?php echo $t['teaTel']?></td>
    <td><br><?php echo $t['teaEmail']?></td>
    <td><a href="<?php echo base_url();?>index.php/teachers/teaedit/<?php echo $t['teaId']?>">แก้ไขข้อมูล</a></td>
  </tr>
  <?php }?>
</table>
</div>
